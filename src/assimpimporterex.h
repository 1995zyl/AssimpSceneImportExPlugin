...
#ifndef QT3D_ASSIMPIMPORTEREX_H
#define QT3D_ASSIMPIMPORTEREX_H
...
class AssimpImporterEx : public QSceneImporter
{
    Q_OBJECT
...
private:
    ...
    QDir     m_sceneDir;
    bool     m_sceneParsed;
    AssimpImporterEx::SceneImporter *m_scene;
    static QStringList assimpSupportedFormatsList;
    AssimpHelperEx::TextureDataByStb m_texureByStb;
};
